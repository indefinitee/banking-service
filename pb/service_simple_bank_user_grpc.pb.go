...
type SimpleBankClient interface {
	...
	LoginUser(ctx context.Context, in *LoginUserRequest, opts ...grpc.CallOption) (*LoginUserRequest, error)
}
...
func (c *simpleBankClient) LoginUser(ctx context.Context, in *LoginUserRequest, opts ...grpc.CallOption) (*LoginUserRequest, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LoginUserRequest)
...
type SimpleBankServer interface {
	...
	LoginUser(context.Context, *LoginUserRequest) (*LoginUserRequest, error)
...
func (UnimplementedSimpleBankServer) LoginUser(context.Context, *LoginUserRequest) (*LoginUserRequest, error) {
...
var SimpleBank_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "service_simple_bank_user.proto",
}
