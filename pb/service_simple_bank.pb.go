...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_update_user.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x16rpc_verify_email.proto2\xe9\x04\n" +
	"\n" +
	"SimpleBank\x12\x8c\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"O\x92A2\x12\x0fCreate new user\x1a\x1fUse this API to create new user\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12\x8e\x01\n" +
	"\n" +
	"UpdateUser\x12\x15.pb.UpdateUserRequest\x1a\x16.pb.UpdateUserResponse\"Q\x92A4\x12\x10Update user info\x1a Use this API to update user info\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update_user\x12\xa3\x01\n" +
	"\tLoginUser\x12\x14.pb.LoginUserRequest\x1a\x15.pb.LoginUserResponse\"i\x92AM\x12\n" +
	"Login user\x1a?Use this API to login user and get access token & refresh token\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_user\x12\x94\x01\n" +
	"\vVerifyEmail\x12\x16.pb.VerifyEmailRequest\x1a\x17.pb.VerifyEmailResponse\"T\x92A6\x12\x11verify user email\x1a!Use this API to verify user email\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/v1/verify_emailB\x80\x01\x92AW\x12U\n" +
	"\x0fSimple Bank API\"=\n" +
	"\tYuno Tech\x12\x1dhttps://github.com/yunoo-tech\x1a\x11yunoo@example.com2\x031.2Z$github.com/indefinitee/simplebank/pbb\x06proto3"
